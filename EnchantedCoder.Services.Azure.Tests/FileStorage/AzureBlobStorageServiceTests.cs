...
using EnchantedCoder.Services.Azure.FileStorage;
using EnchantedCoder.Services.Azure.Tests.FileStorage.Infrastructure;
...
namespace EnchantedCoder.Services.Azure.Tests.FileStorage
{
	[TestClass]
	public class AzureBlobStorageServiceTests
	{
		...
		{
			// we do not want to leak our Azure Storage connection string + we need to have it accessible for build + all Enchanted Coder developers as easy as possible
