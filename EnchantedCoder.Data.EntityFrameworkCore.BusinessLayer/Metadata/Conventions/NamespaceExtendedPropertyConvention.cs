...
{
	/// <summary>
	/// Konvencia pre nastavenie Namespace extended property na všetky entity v modeli. Z namespace triedy sa odstráni názov assembly (EnchantedCoder.{Projekt}.Model.Common -> Common).
	/// </summary>
		...
		public void ProcessKeyAdded(IConventionKeyBuilder keyBuilder, IConventionContext<IConventionKeyBuilder> context)
		{
			...
			var localizationInterfaceType = entityType.ClrType.GetInterfaces()
				.FirstOrDefault(iType =>
					iType.IsGenericType &&
					(iType.GetGenericTypeDefinition() == typeof(EnchantedCoder.Model.Localizations.ILocalization<,>)));
