...
public class ServiceAttribute<TServiceType1, TServiceType2, TServiceType3> : ServiceAttributeBase
{
	/// <summary>
	...
	{
		return new Type[] { typeof(TServiceType1), typeof(TServiceType2), typeof(TServiceType3) };
	}
}
