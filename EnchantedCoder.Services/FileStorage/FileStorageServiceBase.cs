...
using EnchantedCoder.Services.FileStorage.Infrastructure;
...
namespace EnchantedCoder.Services.FileStorage
{
	...
	public abstract class FileStorageServiceBase : IFileStorageService
	{
		...
		public void ReadToStream(string fileName, Stream stream)
		{
			...
			{
				// použití NonClosingWrappingStreamu testuje EnchantedCoder.Services.Tests.FileStorage.FileStorageServiceTestInternals.FileStorageService_SavedAndReadContentsAreSame_Perform
		...
		{
			// Task 66700: EnchantedCoder.Services.FileStorage.FileStorageServiceBase.PerformMove neporovnává sourceFileName a targetFileName
