...
using EnchantedCoder.Extensions.DependencyInjection.Abstractions.Tests.Infrastructure;
...
namespace EnchantedCoder.Extensions.DependencyInjection.Tests
{
	...
	public class ServiceAttributeTests
	{
		...
		public void ServiceAttribute_ToString()
		{
			...
			// Assert
			Assert.AreEqual("Profile = \"MyProfile\", ServiceTypes = { EnchantedCoder.Extensions.DependencyInjection.Abstractions.Tests.Infrastructure.IFirstService, EnchantedCoder.Extensions.DependencyInjection.Abstractions.Tests.Infrastructure.ISecondService }, Lifetime = Singleton", result);
		}
