...
namespace EnchantedCoder.Data.EntityFrameworkCore.BusinessLayer.ModelExtensions.ExtendedProperties.Attributes
{
	/// <summary>
	/// Atribút pre nastavenie MethodAccessModifier extended property na uloženej procedúre.
	/// </summary>
	[AttributeUsage(AttributeTargets.Method)]
	public class MethodAccessModifierAttribute : ModelExtensionExtendedPropertiesAttribute
	{
		/// <inheritdoc />
