...
using EnchantedCoder.Services.TestHelpers;
...
namespace EnchantedCoder.Services.Tests.FileStorage
{
	...
	public class FileSystemStorageServiceTests
	{
		...
		public void FileSystemStorageService_EnumerateFiles_DoesNotContainStoragePath()
		{
			...
			// Act
			List<EnchantedCoder.Services.FileStorage.FileInfo> fileInfos = fileSystemStorageService.EnumerateFiles().ToList();
		...
		public async Task FileSystemStorageService_EnumerateFilesAsync_DoesNotContainStoragePath()
		{
			...
			// Act
			List<EnchantedCoder.Services.FileStorage.FileInfo> fileInfos = await fileSystemStorageService.EnumerateFilesAsync().ToListAsync();
