using EnchantedCoder.Services.StateAdministration;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace EnchantedCoder.Services.Tests.StateAdministrationServices
{
	[TestClass]
	public class IdentifikacniCisloServiceTests
	{
		...
		{
			Assert.IsTrue(IdentifikacniCisloServices.Validate("25612697"));  // Enchanted Coder
